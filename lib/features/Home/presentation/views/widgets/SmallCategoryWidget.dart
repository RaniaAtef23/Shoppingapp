      ...
      child: Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(12.r), // Responsive rounded corners for a modern look
            boxShadow: [
              BoxShadow(
                color: Colors.grey.withOpacity(0.3), // Shadow color
                spreadRadius: 2.r, // Responsive spread radius
                blurRadius: 4.r, // Responsive blur radius for depth effect
                offset: Offset(0, 3.h), // Responsive shadow position
              ),
            ],
